...
//     sm_config_set_sideset(&c, 2, false, false);
    ...
    float fdiv=(clock_get_hz(clk_sys)/80000000);//частота VGA по умолчанию 25175000.0
...
void __not_in_flash_func(send595)(uint16_t data){pioAY595->txf[sm_AY595]=data<<16;}